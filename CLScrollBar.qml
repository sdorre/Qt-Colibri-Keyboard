...
Rectangle{
    ...
    property Image sledImageWhenHovered: sledImage
    property Image sledImageWhenPressed: sledImage
    ...
    property Image previous: Image { //this property is "private" don't write it to documentation
        ...
        smooth: true
        height: scrollBar.height*0.8
        width: scrollBar.width*0.15*0.6
    }
