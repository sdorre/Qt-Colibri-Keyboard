...
Rectangle {
    ...
    property color boxColorWhenToday : "red" //styleen vai ei?
    ...
    property bool gradientTodayOn: true //styleen?
    ...
    property bool monthChangerGradientOn: gradientDefaultOn //styleen
    property color monthChangerBgColor: boxColorWhenDefault

    property color bgColor : "transparent" //hae stylestä myöhemmin vaikka
